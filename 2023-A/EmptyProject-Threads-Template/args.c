...
const char *gengetopt_args_info_help[] = {
  ...
  "  -l, --length=INT   length",
  "  -s, --sort=STRING  sort  (default=`asc')",
    0
};
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->sort_arg = gengetopt_strdup ("asc");
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->sort_help = gengetopt_args_info_help[3] ;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->length_given)
    {
      fprintf (stderr, "%s: '--length' ('-l') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVl:s:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 's':	/* sort.  */
          ...
          if (update_arg( (void *)&(args_info->sort_arg), 
              ...
              &(local_args_info.sort_given), optarg, 0, "asc", ARG_STRING,
              check_ambiguity, override, 0, 0,
              "sort", 's',
              additional_error))
            goto failure;
