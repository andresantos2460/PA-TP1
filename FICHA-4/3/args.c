...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->thread_help = gengetopt_args_info_help[2] ;
  args_info->file_help = gengetopt_args_info_help[3] ;
  args_info->byte_help = gengetopt_args_info_help[4] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->byte_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->byte_given)
    write_into_file(outfile, "byte", args_info->byte_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->thread_given)
    {
      fprintf (stderr, "%s: '--thread' ('-t') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  if (! args_info->byte_given)
    {
      fprintf (stderr, "%s: '--byte' ('-b') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'b':	/* byte.  */
          ...
          if (update_arg( (void *)&(args_info->byte_arg), 
               &(args_info->byte_orig), &(args_info->byte_given),
              &(local_args_info.byte_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "byte", 'b',
              additional_error))
            goto failure;
