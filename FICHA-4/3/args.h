...
struct gengetopt_args_info
{
  ...
  int thread_arg;	/**< @brief thread.  */
  char * thread_orig;	/**< @brief thread original value given at command line.  */
  const char *thread_help; /**< @brief thread help description.  */
  ...
  int byte_arg;	/**< @brief byte.  */
  char * byte_orig;	/**< @brief byte original value given at command line.  */
  const char *byte_help; /**< @brief byte help description.  */
  ...
  unsigned int byte_given ;	/**< @brief Whether byte was given.  */
