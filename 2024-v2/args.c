...
const char *gengetopt_args_info_help[] = {
  ...
  "  -s, --size=INT        size  (default=`10')",
  "  -t, --target=INT      target",
  "  -n, --numthreads=INT  numthreads",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->size_help = gengetopt_args_info_help[2] ;
  args_info->target_help = gengetopt_args_info_help[3] ;
  args_info->numthreads_help = gengetopt_args_info_help[4] ;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->numthreads_given)
    {
      fprintf (stderr, "%s: '--numthreads' ('-n') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVs:t:n:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 't':	/* target.  */
          ...
          if (update_arg( (void *)&(args_info->target_arg), 
              ...
              &(local_args_info.target_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "target", 't',
              additional_error))
            goto failure;
